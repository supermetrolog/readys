 ...
 * CIndustryPeoples
 *
 * @ORM\Table(name="c_industry_peoples", indexes={@ORM\Index(name="clyent_id", columns={"clyent_id"}), @ORM\Index(name="phones", columns={"phones"}), @ORM\Index(name="agent", columns={"agent"}), @ORM\Index(name="dt_insert", columns={"dt_insert"}), @ORM\Index(name="allow_view", columns={"allow_view"}), @ORM\Index(name="deleted", columns={"deleted"})})
 * @ORM\Entity
 */
class CIndustryPeoples
{
    /**
     * @var integer
     *
