...
$imgsets = array(
 'maxsize' => 6000,          // maximum file size, in KiloBytes (2 MB)
 'maxwidth' => 3001,          // maximum allowed width, in pixels
 'maxheight' => 3001,         // maximum allowed height, in pixels
...
if(isset($_FILES['upload']) && strlen($_FILES['upload']['name']) > 1) {
  ...
  $img_name = time().basename($_FILES['upload']['name']);
